...
//		}
		...
		Log.d(TAG, "receive msg seq id:" + seqid + " msg code:"+ msgCode + " hex:0x"+ Integer.toHexString(msgCode));
	...
	private boolean sendUAInfoReq() {
		ByteBuffer sendbuf = TestServerInfo.getUAByteBuffer(mThread.msgSeq, 
				mThread.msgAck,
				mRedirectTimes);
