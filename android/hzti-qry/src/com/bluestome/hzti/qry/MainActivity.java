...
public class MainActivity extends Activity implements OnClickListener {
        ...
        switch (vid) {
            ...
            case R.id.btn_ok:
                ...
                new Thread(new Runnable() {
                    @Override
                    public void run() {
                        if (null != Constants.sb && !Constants.sb.toString().equals("")) {
                            QueryTools.doQuery(Constants.sb.toString(), Constants.URL, carId,
    ...
    synchronized void loadImage2(final String site, final int id) {
