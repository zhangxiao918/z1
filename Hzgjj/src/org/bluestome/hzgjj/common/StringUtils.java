...
public class StringUtils extends org.apache.commons.lang.StringUtils {
    ...
    public static String[] invisibleChars = {
     ...
     * @return
     */
    public static String truncateFixLength(String input, int length) {
        if (null == input) {
            return null;
        }
    ...
    public static String int2EyptStr(int num) {
        ...
        while (0 != num && i < 32) {
            int v = num % 32;
            if (v < 10)
                tmp[31 - i] = (char) (v + (int) '0');
            else
                tmp[31 - i] = (char) (v - 10 + (int) 'A');
            num = num / 32;
            i++;
        }
    ...
    public static String escapeSingleQuotes(String str) {
        if (str == null) {
            ...
            String string = StringUtils.replace(str, "'", "''");
            return "'" + string + "'";
        }
    }
...
/**
    ...
    public static String convertNewlines(String input) {
        ...
        for (int i = 0; i < len; i++) {
            ...
            if (chars[i] == '\n') {
                buf.append(chars, cur, i - cur).append(StringUtils.BR_TAG);
                cur = i + 1;
            }
    ...
    public static String[] removeCommonWords(String[] words) {
        ...
        if (commonWordsMap == null) {
            synchronized (StringUtils.initLock) {
                if (commonWordsMap == null) {
